...
--
-- Client :  127.0.0.1
-- Généré le :  Dim 22 Janvier 2017 à 21:24
...
--
-- Structure de la table `code_client`
--

CREATE TABLE `code_client` (
  `id` int(11) NOT NULL,
  `code_client` varchar(500) NOT NULL,
  `id_maison` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Contenu de la table `code_client`
--

INSERT INTO `code_client` (`id`, `code_client`, `id_maison`) VALUES
(1, 'fb05c54ddd894a1543f046469ed63241', 0),
(2, 'd1f5c3c55a7403dd93075d91dd8ef948', 2),
(3, 'a62dc3e49f4438d50ff75226b66509f0', 10),
(4, '4c6effbc541ba09707f811f6a72a7efd', 11),
(5, '654156487d9387a446e1d271dbebbfbc', 12),
(6, 'afd6000522f4605d350ee67804bf9b5f', 13),
(7, 'e4b8ece361804e5f2cc5b6af8219c300', 14),
(8, 'bd7d4b9d1a26a9ba166adaa034b5e967', 15),
(9, '3779eb905e58e3099c700c8bab991daa', 16),
(10, 'e1b0e8e86fc7a754e22b363c55141c36', 17),
(11, 'dfceaf7923e65a863164492787a034a4', 18),
(12, '0ad4dda214d258baa510269878c4091c', 19),
(13, '2de5796f4948418c396ab8c6bbd83d38', 20),
(14, 'b54df3bcbc29aaac3a16a84c1a05cbec', 21),
(15, 'e346226635b197ccb19ba82251df997e', 22),
(16, '52bc4c7b3824ccf3780f7768130d331e', 23),
(17, '4870865fb25b001a1be83070fa0bea1b', 24);
...
INSERT INTO `maison` (`id`, `id_type_maison`, `adresse`, `postal`, `ville`) VALUES
(1, 2, '', 0, ''),
(2, 2, '', 0, ''),
(5, 2, 'ok', 77400, 'paris'),
(6, 2, 'ok', 77400, 'paris'),
...
(9, 2, 'ok', 77400, 'paris'),
(10, 2, 'ok', 77400, 'paris'),
(11, 2, '17 rue de la grande grille', 77400, 'Saint thibault des vignes'),
(12, 2, 'coucou', 95050, 'PAris'),
(13, 2, 'coucou', 95050, 'PAris'),
(14, 2, 'coucou', 95050, 'PAris'),
(15, 2, 'coucou', 95050, 'PAris'),
(16, 2, 'test', 92, 'test'),
(17, 2, 'test', 92, 'test'),
(18, 2, 'test', 92, 'test'),
(19, 2, 'test', 92, 'test'),
...
(4, 'secu1', 0, 3, '1', 0, 0, '', 0, '', '0000-00-00', 'disfonctionnement'),
(5, 'lumi1', 0, 2, '1', 0, 0, '', 0, '', '0000-00-00', 'disfonctionnement'),
(6, 'lumi2', 2, 2, '2', 0, 0, '', 0, '', '0000-00-00', 'disfonctionnement'),
(7, 'secu2', 2, 3, '2', 0, 0, '', 0, '', '0000-00-00', 'disfonctionnement'),
(8, 'secu3', 2, 3, '1', 0, 0, '', 0, '', '0000-00-00', 'disfonctionnement'),
...
--
-- Index pour la table `code_client`
--
ALTER TABLE `code_client`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT pour la table `code_client`
--
ALTER TABLE `code_client`
