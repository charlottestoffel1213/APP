        ...
        <ul>
            ...
            if ($_GET['cible']=='users'){
                ...
                switch ($mode){
                    ...
                    case "mode":
                    $req1 = selection($bdd,'mode_obj_pers','nom_mode','id_maison', $_SESSION['maison'] );

                    echo('<li><a>Mode</a></li>
                        <li><a href="index.php?cible=users&function=mode&type=nuit">Nuit</a></li>');

                     while($key = $req1->fetch()) {
                        echo ('
                        <li><a href="index.php?cible=users&function=mode&type='.$key['nom_mode'].'"> '. $key['nom_mode'] . '</a></li>
                        '); }
                        if($_SESSION['id_type_utilisateur'] == 1){
                            echo ('<li><a href = "index.php?cible=users&function=configmode">Ajouter</a></li>');
                        }
