...
<tr>
	...
	<td class="switch">
		<div class="onoffswitch">
	        <input type="checkbox" name="check3[]" class="onoffswitch-checkbox" id="myonoffswitch<?=$i?>" value="<?php echo $obj['id']; ?>" <?php echo $checked=($obj['donnee_recue']==1)?'checked':''; ?>>
...
<br/>
<input type="submit" name="submit_secu" class="submit">
</body>
</html>
